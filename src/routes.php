...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    Route::post(config('pulsar.appName') . '/cms/articles/store/{lang}/{offset}/{tab}/{id?}',            ['as'=>'storeCmsArticle',                'uses'=>'Syscover\Cms\Controllers\Articles@storeRecord',                'resource' => 'cms-article',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/cms/articles/{id}/edit/{lang}/{offset}/{tab}',               ['as'=>'editCmsArticle',                 'uses'=>'Syscover\Cms\Controllers\Articles@editRecord',                 'resource' => 'cms-article',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/cms/articles/update/{lang}/{id}/{offset}/{tab}',             ['as'=>'updateCmsArticle',               'uses'=>'Syscover\Cms\Controllers\Articles@updateRecord',               'resource' => 'cms-article',        'action' => 'edit']);
    ...
    Route::get(config('pulsar.appName') . '/cms/articles/delete/translation/{lang}/{id}/{offset}/{tab}', ['as'=>'deleteTranslationCmsArticle',    'uses'=>'Syscover\Cms\Controllers\Articles@deleteTranslationRecord',    'resource' => 'cms-article',        'action' => 'delete']);
    ...
    Route::post(config('pulsar.appName') . '/cms/articles/check/article/slug',                           ['as'=>'apiCheckSlugCmsArticle',         'uses'=>'Syscover\Cms\Controllers\Articles@apiCheckSlug',               'resource' => 'cms-article',        'action' => 'access']);
