...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | ARTICLE ATTACHMENT FAMILIES
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/cms/article/attachment/families/{offset?}',                          ['as'=>'CmsArticleAttachmentFamily',                   'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@index',                      'resource' => 'cms-article-attachment-family',        'action' => 'access']);
    Route::any(config('pulsar.appName') . '/cms/article/attachment/families/json/data',                          ['as'=>'jsonDataCmsArticleAttachmentFamily',           'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@jsonData',                   'resource' => 'cms-article-attachment-family',        'action' => 'access']);
    Route::get(config('pulsar.appName') . '/cms/article/attachment/families/create/{offset}',                    ['as'=>'createCmsArticleAttachmentFamily',             'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@createRecord',               'resource' => 'cms-article-attachment-family',        'action' => 'create']);
    Route::post(config('pulsar.appName') . '/cms/article/attachment/families/store/{offset}',                    ['as'=>'storeCmsArticleAttachmentFamily',              'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@storeRecord',                'resource' => 'cms-article-attachment-family',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/cms/article/attachment/families/{id}/edit/{offset}',                 ['as'=>'editCmsArticleAttachmentFamily',               'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@editRecord',                 'resource' => 'cms-article-attachment-family',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/cms/article/attachment/families/update/{id}/{offset}',               ['as'=>'updateCmsArticleAttachmentFamily',             'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@updateRecord',               'resource' => 'cms-article-attachment-family',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/cms/article/attachment/families/delete/{id}/{offset}',               ['as'=>'deleteCmsArticleAttachmentFamily',             'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@deleteRecord',               'resource' => 'cms-article-attachment-family',        'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/cms/article/attachment/families/delete/select/records',           ['as'=>'deleteSelectCmsArticleAttachmentFamily',       'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@deleteRecordsSelect',        'resource' => 'cms-article-attachment-family',        'action' => 'delete']);
    Route::any(config('pulsar.appName') . '/cms/article/attachment/families/{id}/show/{api}',                    ['as'=>'apiShowCmsArticleAttachmentFamily',            'uses'=>'Syscover\Cms\Controllers\ArticleAttachmentFamilyController@showRecord',                 'resource' => 'cms-article-attachment-family',        'action' => 'access']);
