...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/cms/articles/create/{lang}/{offset}/{id?}',                  ['as'=>'createCmsArticles',               'uses'=>'Syscover\Cms\Controllers\Articles@createRecord',               'resource' => 'cms-article',        'action' => 'create']);
