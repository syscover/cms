...
Route::group(['middleware' => ['auth.pulsar','permission.pulsar','locale.pulsar']], function() {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/cms/article/families/{offset?}',                          ['as'=>'CmsArticleFamily',                   'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@index',                      'resource' => 'cms-article-families',        'action' => 'access']);
    Route::any(config('pulsar.appName') . '/cms/article/families/json/data',                          ['as'=>'jsonDataCmsArticleFamily',           'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@jsonData',                   'resource' => 'cms-article-families',        'action' => 'access']);
    Route::get(config('pulsar.appName') . '/cms/article/families/create/{offset}',                    ['as'=>'createCmsArticleFamily',             'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@createRecord',               'resource' => 'cms-article-families',        'action' => 'create']);
    Route::post(config('pulsar.appName') . '/cms/article/families/store/{offset}',                    ['as'=>'storeCmsArticleFamily',              'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@storeRecord',                'resource' => 'cms-article-families',        'action' => 'create']);
    Route::get(config('pulsar.appName') . '/cms/article/families/{id}/edit/{offset}',                 ['as'=>'editCmsArticleFamily',               'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@editRecord',                 'resource' => 'cms-article-families',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/cms/article/families/update/{id}/{offset}',               ['as'=>'updateCmsArticleFamily',             'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@updateRecord',               'resource' => 'cms-article-families',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/cms/article/families/delete/{id}/{offset}',               ['as'=>'deleteCmsArticleFamily',             'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@deleteRecord',               'resource' => 'cms-article-families',        'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/cms/article/families/delete/select/records',           ['as'=>'deleteSelectCmsArticleFamily',       'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@deleteRecordsSelect',        'resource' => 'cms-article-families',        'action' => 'delete']);
    Route::any(config('pulsar.appName') . '/cms/article/families/{id}/show/{api}',                    ['as'=>'apiShowCmsArticleFamily',            'uses'=>'Syscover\Cms\Controllers\ArticleFamilyController@showRecord',                 'resource' => 'cms-article-families',        'action' => 'access']);
