...
@section('box_tab1')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => trans('pulsar::pulsar.link'), 'containerId' => 'linkContent', 'name' => 'link', 'value' => $object->link_355, 'maxLength' => '255', 'rangeLength' => '2,255'])
