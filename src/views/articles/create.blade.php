                ...
                if($("[name=family]").val())
                {
                    ...
                    $.ajax({
                        ...
                        success:  function(data)
                        {
                            ...
                            if(properties.date){ $('#dateContent').fadeIn();hasProperty=true;}
                            if(properties.title){ $('#titleContent').fadeIn();hasProperty=true;}
                            if(properties.slug){ $('#slugContent').fadeIn();hasProperty=true;}
                            if(properties.sorting){ $('#sortingContent').fadeIn();hasProperty=true;}
                            if(properties.tags){ $('#tagsContent').fadeIn();hasProperty=true;}
