...
@section('rows')
    ...
    @include('pulsar::includes.html.form_text_group', ['label' => trans('pulsar::pulsar.width') . ' (px)', 'name' => 'width', 'value' => Input::old('width'), 'fieldSize' => 2, 'type' => 'number', 'inputs' => [
            ['label' => trans('pulsar::pulsar.height') . ' (px)', 'name' => 'height', 'value' => Input::old('height'), 'fieldSize' => 2, 'type' => 'number']
        ]])
